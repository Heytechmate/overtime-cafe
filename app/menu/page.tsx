...
export default function MenuPage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 p-4 md:p-12 font-sans">
      ...
      <div className="flex gap-3 mb-8 max-w-6xl mx-auto overflow-x-auto pb-4 scrollbar-hide">
...
function CategoryBtn({ label, icon, active, onClick }: any) {
  ...
  return (
    <Button 
      ...
      className={`rounded-full whitespace-nowrap ${isActive ? "bg-stone-200 hover:bg-stone-300 text-stone-800" : "text-stone-500 hover:text-stone-900 hover:bg-stone-100"}`}
    >
      {icon} {label}
    </Button>
  )
